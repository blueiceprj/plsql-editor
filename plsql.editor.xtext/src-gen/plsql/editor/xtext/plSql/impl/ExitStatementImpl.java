 ...
 * <ul>
 *   <li>{@link plsql.editor.xtext.plSql.impl.ExitStatementImpl#getLabelName <em>Label Name</em>}</li>
 *   <li>{@link plsql.editor.xtext.plSql.impl.ExitStatementImpl#getWhenExpression <em>When Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExitStatementImpl extends StatementImpl implements ExitStatement
{
  ...
  {
    return PlSqlPackage.Literals.EXIT_STATEMENT;
  }
  ...
  public void setLabelName(String newLabelName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlSqlPackage.EXIT_STATEMENT__LABEL_NAME, oldLabelName, labelName));
  }
  ...
  public NotificationChain basicSetWhenExpression(Expression newWhenExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PlSqlPackage.EXIT_STATEMENT__WHEN_EXPRESSION, oldWhenExpression, newWhenExpression);
  ...
  public void setWhenExpression(Expression newWhenExpression)
  {
    if (newWhenExpression != whenExpression)
    {
      ...
      if (whenExpression != null)
        msgs = ((InternalEObject)whenExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PlSqlPackage.EXIT_STATEMENT__WHEN_EXPRESSION, null, msgs);
      if (newWhenExpression != null)
        msgs = ((InternalEObject)newWhenExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PlSqlPackage.EXIT_STATEMENT__WHEN_EXPRESSION, null, msgs);
      msgs = basicSetWhenExpression(newWhenExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlSqlPackage.EXIT_STATEMENT__WHEN_EXPRESSION, newWhenExpression, newWhenExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PlSqlPackage.EXIT_STATEMENT__WHEN_EXPRESSION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PlSqlPackage.EXIT_STATEMENT__LABEL_NAME:
        return getLabelName();
      case PlSqlPackage.EXIT_STATEMENT__WHEN_EXPRESSION:
