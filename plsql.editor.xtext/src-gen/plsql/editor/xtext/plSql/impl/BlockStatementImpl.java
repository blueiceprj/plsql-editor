 ...
 * <ul>
 *   <li>{@link plsql.editor.xtext.plSql.impl.BlockStatementImpl#getDeclareSection <em>Declare Section</em>}</li>
 *   <li>{@link plsql.editor.xtext.plSql.impl.BlockStatementImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BlockStatementImpl extends StatementImpl implements BlockStatement
{
  ...
  {
    return PlSqlPackage.Literals.BLOCK_STATEMENT;
  }
  ...
  public NotificationChain basicSetDeclareSection(DeclareSection newDeclareSection, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PlSqlPackage.BLOCK_STATEMENT__DECLARE_SECTION, oldDeclareSection, newDeclareSection);
  ...
  public void setDeclareSection(DeclareSection newDeclareSection)
  {
    if (newDeclareSection != declareSection)
    {
      ...
      if (declareSection != null)
        msgs = ((InternalEObject)declareSection).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PlSqlPackage.BLOCK_STATEMENT__DECLARE_SECTION, null, msgs);
      if (newDeclareSection != null)
        msgs = ((InternalEObject)newDeclareSection).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PlSqlPackage.BLOCK_STATEMENT__DECLARE_SECTION, null, msgs);
      msgs = basicSetDeclareSection(newDeclareSection, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlSqlPackage.BLOCK_STATEMENT__DECLARE_SECTION, newDeclareSection, newDeclareSection));
  }
  ...
  public NotificationChain basicSetBody(StatementBody newBody, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PlSqlPackage.BLOCK_STATEMENT__BODY, oldBody, newBody);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setBody(StatementBody newBody)
  {
    if (newBody != body)
    {
      NotificationChain msgs = null;
      if (body != null)
        msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PlSqlPackage.BLOCK_STATEMENT__BODY, null, msgs);
      if (newBody != null)
        msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PlSqlPackage.BLOCK_STATEMENT__BODY, null, msgs);
      msgs = basicSetBody(newBody, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlSqlPackage.BLOCK_STATEMENT__BODY, newBody, newBody));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PlSqlPackage.BLOCK_STATEMENT__DECLARE_SECTION:
        return basicSetDeclareSection(null, msgs);
      case PlSqlPackage.BLOCK_STATEMENT__BODY:
