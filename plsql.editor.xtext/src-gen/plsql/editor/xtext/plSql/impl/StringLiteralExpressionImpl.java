 ...
 * <ul>
 *   <li>{@link plsql.editor.xtext.plSql.impl.StringLiteralExpressionImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralExpressionImpl extends ExpressionImpl implements StringLiteralExpression
{
  ...
  {
    return PlSqlPackage.Literals.STRING_LITERAL_EXPRESSION;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PlSqlPackage.STRING_LITERAL_EXPRESSION__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PlSqlPackage.STRING_LITERAL_EXPRESSION__VALUE:
        return getValue();
    }
