 ...
 * <ul>
 *   <li>{@link plsql.editor.xtext.plSql.QualifiedName#getNames <em>Names</em>}</li>
 * </ul>
 * </p>
 *
 * @see plsql.editor.xtext.plSql.PlSqlPackage#getQualifiedName()
 * @model
 * @generated
 */
public interface QualifiedName extends EObject
{
   ...
   * The list contents are of type {@link plsql.editor.xtext.plSql.Name}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see plsql.editor.xtext.plSql.PlSqlPackage#getQualifiedName_Names()
